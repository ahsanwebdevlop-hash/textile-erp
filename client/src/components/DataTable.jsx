...
export default function DataTable({ columns, data, searchable = true, searchKeys = [], actions = null, pageSize = 10, title = 'Data' }) {
    ...
    <div className="card overflow-hidden">
      <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-3">
          <span className="text-xs font-semibold text-gray-500">{filtered.length} Records</span>
          <button 
